...
\subsection{Resultat}
Aus den Resultaten aus Kapitel \ref{auswertung1} soll nun die effizienteste Stratgie ermittelt werden. \newline
...
Die erzielten Dialogzeiten zeigen deutlich, dass Stratgie 1 sowohl in den Runde mit als auch ohne Rennspiel den kürzesten Dialog ermöglicht. Aus den Antworten des Nasa-TLX Teil des Fragebogens wird deutlich, dass Strategie 1 von den Benutzern am unbelastesten gewertet wurde.  In allen Fragen des zweiten Teil des Fragebogens wurde ebenfalls Strategie 1 am besten bewertet und durch die letzten Frage deutlich als beliebteste Strategie gewertet.  Laut Task Completion ist Strategie 2 am erfolgreichsten. 
\begin{comment}
