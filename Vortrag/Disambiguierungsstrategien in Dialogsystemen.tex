...
\begin{block}{Wie alt sind Sie?} Altereingabe \end{block}
\begin{table}
\begin{tabular}{l|l|l}
...
%\caption{Interaktionsbeispiel \texttt{Aggregierte Auswahl ohne Pause}}
\end{table}
\begin{block}{Haben Sie Erfahrung mit Dialogsystemen?} 1: gar keine Erfahrung 6: viel Erfahrung \end{block}
\begin{table}
...
\end{tabular}
\end{table}
\begin{block}{Spielen Sie oft Rennspiele?} 1: sehr oft 6: nie  \end{block}
\begin{block}{Wie technikaffin sind Sie?} 1: sehr technikaffin 6: gar nicht technikaffin \end{block}
\begin{block}{Wie schwer fiel Ihnen die Einführungsrunde?} 1: sehr schwer 6: sehr einfach \end{block}
}

\frame{\frametitle{Versuchsperson - Fragebogen}
\includegraphics[scale=0.38]{ErfDia1}
\newline
\includegraphics[scale=0.38]{oftRS1}
\begin{block}{Wie technikaffin sind Sie?} 1: sehr technikaffin 6: gar nicht technikaffin \end{block}
\begin{block}{Wie schwer fiel Ihnen die Einführungsrunde?} 1: sehr schwer 6: sehr einfach \end{block}
}
