...
Versuch 1 zeige eindeutiges Ergebnis bei Disambiguierung über 2 Alternativen \newline
...
\begin{figure}[htbp]
	...
	\begin{minipage}{0.60\textwidth} 
		\begin{itemize}
			...
			\item 2 Slots pro Anruf abgefragt
			\item pro Anruf unterschiedl. Strategie
			\item Disambiguierung mit 6 Alternativen
		\end{itemize}
	\end{minipage}
	\hfill
	\begin{minipage}{0.30\textwidth}
	\fbox{\includegraphics[scale=0.13]{Anke2}}
	\label{Adressbuch} 
	\end{minipage}
% \caption{noch eine Caption}
\end{figure}
