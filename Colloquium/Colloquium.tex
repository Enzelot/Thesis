...
$\rightarrow$ Sprachäußerungen müssen durchdacht formuliert werden
}
...
\newline
\item Versuchsperson wird der Eindruck verliehen, sie würde mit einem echten Dialogsystem interagieren
...
\item Dialog aus Strategie 1 gefiel am besten, Strategie 3 am schlechtesten
...
\newline
\end{itemize}
$\rightarrow$ Unterschied gering: 0.05
}
...
\frame{\frametitle{Auswertung - Zusammenfassung}
\begin{block}{Erkenntnis}Länge der Disambiguierung beeinflusst Strategienbeliebtheit\end{block}
...
\bibitem[Abdi et al., 2010]{TukeyTest} Hervé Abdi und Lynne J. Williams: \textit{Newmann-Keuls Test and Tukey Test} 
(2006).
...
\frame{\frametitle{Statistische Signifikanz}
\begin{itemize}
